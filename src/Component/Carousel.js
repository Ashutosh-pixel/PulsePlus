...
const Carousel = () => {
  ...
  return (
    <div className="Carouselimg flex-col items-center justify-center">
      <h1 className="text-center text-3xl sm:text-5xl p-4 font-bold text-[#87CEEB]">
        PulsePlus
      </h1>
      <p className=" text-center text-sm text-[#87CEEB]">
      ...
      <AliceCarousel
        ...
        items={arr?.map((curr) => (
          ...
          >
            ...
            <span
              className={getclass(curr.price_change_percentage_24h_in_currency)}
            >
